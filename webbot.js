(function() {
  ...
  style.textContent = `
    ...
    .akwb-avatar{width:34px;height:34px;border-radius:50%;background:#fff;display:flex;align-items:center;justify-content:center;flex-shrink:0;overflow:hidden;border:1px solid rgba(255,255,255,0.15)}
    .akwb-hinfo{flex:1}
  ...
  chatWin.innerHTML = `
    <div class="akwb-header">
      <div class="akwb-avatar"><img src="favicon.png" alt="AK WebWorks" style="width:34px;height:34px;object-fit:cover;border-radius:50%;"></div>
