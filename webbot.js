(function() {
  ...
  style.textContent = `
    ...
    .akwb-avatar{width:34px;height:34px;border-radius:50%;background:#1D5BD4;display:flex;align-items:center;justify-content:center;font-size:13px;font-weight:700;color:#fff;font-family:"IBM Plex Mono",monospace;flex-shrink:0}
    .akwb-hinfo{flex:1}
